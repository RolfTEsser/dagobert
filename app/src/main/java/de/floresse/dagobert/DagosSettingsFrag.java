...
public class DagosSettingsFrag extends PreferenceFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(MainActivity.TAG, "Dago starting SettingsFragment onCreate");
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals("pref_filename")) {
            Log.i(MainActivity.TAG, "filename changed");
...
*/
    ...
    public class myChangeListener implements OnPreferenceChangeListener {
        public boolean onPreferenceChange(Preference pref, Object newVal) {
            ...
            Log.i(MainActivity.TAG, "Dago SettingsFragment onPreferenceChange");
